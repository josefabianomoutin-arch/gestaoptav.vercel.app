...
interface AlmoxarifadoDashboardProps {
    ...
    serviceOrders: any[];
    onRegisterServiceOrder: (order: any) => Promise<{ success: boolean; message: string }>;
    onUpdateServiceOrder: (order: any) => Promise<{ success: boolean; message: string }>;
    onDeleteServiceOrder: (id: string) => Promise<any>;
