...
interface AdminVehicleExitOrderProps {
    ...
    onDeleteVehicleAsset: (id: string) => Promise<any>;
    ...
    onDeleteDriverAsset: (id: string) => Promise<any>;
    ...
    onDeleteValidationRole?: (id: string) => Promise<any>;
    ...
    onDeleteInspection?: (id: string) => Promise<any>;
