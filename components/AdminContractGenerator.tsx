            ...
            {selectedProducer ? (
                <div ref={containerRef} className="bg-white border border-zinc-200 rounded-3xl p-12 shadow-sm max-w-4xl mx-auto font-serif text-zinc-800 leading-relaxed print:shadow-none print:border-none print:p-0">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-4 break-inside-avoid text-justify">
                            ...
                            <div className="overflow-x-auto">
                                <table className="w-full table-fixed border-collapse border border-zinc-300 text-xs text-center">
                                    <thead>
                                        <tr className="bg-zinc-50 break-inside-avoid">
                                    ...
                                    {selectedProducer.contractItems && selectedProducer.contractItems.length > 0 && (
                                        <tfoot>
                                            <tr className="bg-zinc-50 font-bold break-inside-avoid">
                        ...
                        <div className="pt-12 pb-12 text-center break-inside-avoid">
