...
const AdminContractGenerator: React.FC<AdminContractGeneratorProps> = ({ producers, type }) => {
    ...
    return (
        <div className="p-8 space-y-8">
            ...
            {selectedProducer ? (
                <div ref={containerRef} className="bg-white border border-zinc-200 rounded-3xl p-8 shadow-sm max-w-4xl mx-auto font-serif text-zinc-800 leading-normal print:shadow-none print:border-none">
                    <div className="text-center space-y-2 mb-6 pt-10">
                    ...
                    <div className="space-y-1">
                        ...
                        <div className="space-y-4 text-justify break-inside-avoid">
                                    ...
                                    <tbody>
                                        {selectedProducer.contractItems && selectedProducer.contractItems.length > 0 ? (
                                            selectedProducer.contractItems.map((item, idx) => (
                                                <tr key={idx}>
                                                    <td className="border border-zinc-300 p-1 uppercase break-words">{selectedProducer.name}</td>
                                                    <td className="border border-zinc-300 p-1 break-words">{selectedProducer.cpfCnpj}</td>
