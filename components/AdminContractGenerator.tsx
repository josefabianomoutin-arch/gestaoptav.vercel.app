...
const AdminContractGenerator: React.FC<AdminContractGeneratorProps> = ({ producer, type }) => {
    ...
    return (
        <div className="p-8 space-y-8">
            ...
            <div ref={contractRef} className="bg-white p-12 text-black font-sans leading-tight text-[10pt] max-w-[210mm] mx-auto shadow-xl">
                {/* Header Info */}
                ...
                <p className="mb-4">4. Prestar à CONTRATADA as informações e esclarecimentos necessários que eventualmente venham a ser solicitados, que interfiram na execução do contrato;</p>
